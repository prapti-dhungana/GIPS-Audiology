...
- Launch a runtime workspace  using a runtime Eclipse, as stated in the eMoflon::IBeX installation steps.
  
- Download all the required projects into the runtime workspace

- Build all the projects with the black eMoflon hammer.
